...
module load eman2
BASE_DIR=/data/gnye8/fmn_samiv_simulation/CS-fmn-samiv-simulation-1/samiv_simulation/08302023_samiv_stacks
cd $BASE_DIR || exit
...
for pink_noise in ${pink_noise_values[@]}; do
    for i in {1..10}; do
        ...
        ln -s /data/gnye8/fmn_samiv_simulation/CS-fmn-samiv-simulation-1/samiv_simulation/08152023_samiv_stacks/pinknoise0/projections .
        cd ../
        python3 /data/gnye8/internal_EM_scripts/simulate/cryo_simulate_particle_stack.py \
            --input /data/gnye8/fmn_samiv_simulation/CS-fmn-samiv-simulation-1/samiv_simulation/6ues.pdb \
